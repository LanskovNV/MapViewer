...
There are lots of ways to use MapViewer on your computer, phone or tablet. Here are some thongs you can do.
### Move the map
...
### Data filters
You can choose the types of data you want to see now using ***checkboxes*** down below.
## About
