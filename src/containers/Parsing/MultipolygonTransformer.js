 ...
 * @param {Array} arr_multipolygons_coord - multipolygon present as its coordinates (array of polygons)
 * @returns {Array} arr_lines_coords - array of lines representing given polygon
 */
